<?php
  ...
  <br>
  <hr>
  <h4 align='center'>PO Internal</h4>
  <hr>
   <table>
  <tr>
  ...
  <p align='center'>
    <table cellpadding='0' cellspacing='1' style='width: 210mm;' border=0.5>
      <tr bgcolor='#CCCCCC'>
        ...
        <th style='width:350px;'>No.PO Internal</th>
        <th style='width:360px;'>Tgl.PO Internal</th>
      </tr>";
      // Menampilkan data
      $query = mysql_query("
         SELECT * from po_internal
        WHERE YEAR(tgl_po_internal)='$thn' AND MONTH(tgl_po_internal)='$bln' AND status='1'
        GROUP BY no_po_internal");
      $no = 1; // nomor baris
  ...
  $filename="Laporan PO Internal ".$bln."_".$thn.".pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
