...
<head>
  ...
  <title>Halaman | Kepala Admin</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?hal=brg"><i class="fa fa-inbox"></i> <span>Barang</span></a></li>
        <li><a href="index.php?hal=pgw"><i class="fa fa-user"></i> <span>Pegawai</span></a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?hal=lpoi"><i class="glyphicon glyphicon-import"></i> PO Internal</a></li>
            <li><a href="index.php?hal=lpoe"><i class="glyphicon glyphicon-export"></i> PO Eksternal</a></li>
          </ul>
        </li>
