...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <div class="box-body">
       <?php
          $query2 = mysql_query("SELECT b.id_barang as brgdetil, satuan, c.id_barang, nm_barang, qty, satuan from po_eksternal a, detil_po_eksternal b, barang c, retur_eksternal d where a.no_po_eksternal=b.no_po_eksternal and c.id_barang=b.id_barang and d.no_po_eksternal=a.no_po_eksternal and d.no_retur_eksternal='".$_GET['nortr']."' group by c.id_barang ORDER by c.nm_barang asc");
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" style="width: 100%;" name="barang" required="">
                <?php
                $nortr = $_GET['nortr'];
                $query = mysql_query("select a.* from barang a, detil_po_eksternal b, po_eksternal c, retur_eksternal d where a.id_barang=b.id_barang and b.no_po_eksternal=c.no_po_eksternal and c.no_po_eksternal=d.no_po_eksternal and d.no_retur_eksternal='$nortr' group by a.id_barang");
      ...
      <?php
      $record = mysql_query("SELECT e.id_barang as brgdetil, c.satuan, e.id_barang, nm_barang, jml_retur_eksternal
      FROM po_eksternal a, detil_po_eksternal b, barang c, retur_eksternal d, detil_retur_eksternal e
      WHERE a.no_po_eksternal=b.no_po_eksternal and c.id_barang=b.id_barang and a.no_po_eksternal=d.no_po_eksternal and d.no_retur_eksternal=e.no_retur_eksternal and c.id_barang=e.id_barang and e.no_retur_eksternal='$_GET[nortr]'
      ");
      echo'<table class="table table-striped table-bordered table-hover" id="dataTables-example">';
        ...
        echo '<tbody>';
          ...
          echo "<tr'>";
            ...
            echo "<td style='width:110px;  text-align:left; vertical-align: middle;' class='text-capitalize'><a class='btn btn-danger' aria-label='Delete' href='proses/hps_reture.php?brgdetil=$row[brgdetil]'></span>Hapus</a></td>";
          echo '</tr>';
          }
          }
        echo '</tbody>';
      ...
      echo"<div class='box-footer'>
        <a class='btn btn-success' href='index.php?hal=rtre'>Selesai</a>
      </div>";
      ?>
      <!-- END DETIL PO -->
    </div>
