    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="proses/prs_acc.php">
          <div class="row">
          <div class="col-xs-10">
            <div class="form-group"><label>No.PO</label><input class="form-control" data-placement="top" data-trigger="manual" type="text" name="po" maxlength="8" readonly value="<?php echo $row['no_po_internal']; ?>">
          </div>
          </div>
