...
<head>
  ...
  <title>Halaman | Admin Gudang</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="index.php?hal=poe"><i class="glyphicon glyphicon-export"></i> <span>PO Eksternal</span></a></li>
        <li><a href="index.php?hal=sj"><i class="glyphicon glyphicon-transfer"></i> <span>Surat Jalan</span></a></li>
