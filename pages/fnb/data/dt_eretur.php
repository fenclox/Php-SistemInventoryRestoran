  ...
  <section class="content">
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <?php
          $query2 = mysql_query("SELECT b.id_barang as brgdetil, satuan, c.id_barang, nm_barang, qty, satuan from po_internal a, detil_po_internal b, barang c where a.no_po_internal=b.no_po_internal and c.id_barang=b.id_barang and b.no_po_internal='".$_GET['nopo']."' group by c.id_barang ORDER by c.nm_barang asc");
        ...
        <div class="row">
          <div class="col-md-6">
            <form method="POST" action="proses/prs_eretur.php">
              ...
              $query = "select MAX(RIGHT(no_po_internal,2)) as max_id from po_internal where LEFT(no_po_internal, 6)='$dym' ORDER BY no_po_internal";
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" style="width: 100%;" name="barang" required="">
                <?php
                $nopo = $_GET['nopo'];
                $query = mysql_query("select a.* from barang a, detil_po_internal b where a.id_barang=b.id_barang and b.no_po_internal='$nopo'");
